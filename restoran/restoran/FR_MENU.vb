...
Public Class FR_MENU
    ...
    Sub BUKA_FROM(ByVal FR As Form)
        For Each F As Form In Me.MdiChildren
            If F.Name = FR.Name Then
                MsgBox("HALAMAN SUDAH DIBUKA..")
                Exit Sub
            End If
        Next
        FR.MdiParent = Me
    ...
    Private Sub DataKaryawanToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles MenuDataKaryawan.Click
        BUKA_FROM(FR_KARYAWAN)
    End Sub

    Private Sub DataMenuToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles DataMenuToolStripMenuItem.Click
        BUKA_FROM(FR_DATA_MENU)
    End Sub

    Private Sub MasukToolStripMenuItem_Click(sender As Object, e As EventArgs)
        BUKA_FROM(FR_MASUK)
    End Sub
    ...
    Private Sub PengaturanToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles PengaturanToolStripMenuItem.Click
        BUKA_FROM(FR_PENGATURAN)
    End Sub

    'ubah sesuai nama tabel
    Sub data_menu()
